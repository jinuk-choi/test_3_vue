	...
	<div>
		...
		<div class="listWrap">
			<table class="tbList">
				...
				<tr v-for="(list, idx) in boardList" :key="idx">
					<td>{{list.a_idx}}</td>
					<td class="txt_left"><a href="javascript:;">{{list.a_title}}</a></td>
					<td>{{list.a_writer}}</td>
					<td>{{list.a_date}}</td>
				</tr>
...
export default {
	data() { //변수생성
		return{
			...
			boardList: [
				{a_idx: '1', a_title: '안녕', a_writer: '붕어', a_date: '2021.06.21'},
				{a_idx: '2', a_title: 'ㅎㅇ', a_writer: '잉어', a_date: '2021.06.21'},
				{a_idx: '3', a_title: '안녕22' ,a_writer: '메기', a_date: '2021.06.21'}
